...
- Add a separate `tap-rocket-tuning.md` with exact spawn tables and gravity well curves.
- Add `tap-rocket-analytics.md` with KPI definitions and anomaly alerts.
- Add `tap-rocket-controls.md` with input feel, response timings, and accepted tolerance windows.